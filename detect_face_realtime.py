...
# img_path = './datasets/test/random_test.jpg'
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # HumanNames = ['Aguero','Arun','Ashwin','Daking', 'Dembele','Messi','Nitesh', 'Sajeet', 'Saugat','Silva']  # train human name
        ...
        out = cv2.VideoWriter('video.avi', fourcc, fps=5, frameSize=(640, 480))
                    ...
                    for i in range(nrof_faces):
                        ...
                        for H_i in HumanNames:
                            if HumanNames[best_class_indices[0]] == H_i:
                                ...
                                if not best_class_probabilities < 0.7:
